...
## study area:
![study area](land_use_coral_cover_change_area.png)

## methods:
![methods](land_use_coral_cover_change_pipeline.png)

Classification is confounded by turbid waters.
To improve classification, a depth filter was applied.
![depth-filter](land_use_coral_cover_change_depth-limit.png)


## Results:
![result](land_use_coral_cover_change_reef-cover-change.png)
![result w true color](land_use_coral_cover_change_reef-cover-change-w-rgb.png)
