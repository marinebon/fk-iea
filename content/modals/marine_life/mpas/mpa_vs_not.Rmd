...
```{r comparison_png, echo=FALSE}
blogdown::shortcode("imgcap",
    title=" Plots of reef fish indices inside (protected) and outside (not protected) no take marine zones across years in the Florida Keys. The units for panel A are abundance (number of individuals), panel B is kilograms per 40,000 km2, panel C is units ranging from 0 (maximally uneven) to 1 (maximally even), and panels D-G are in units of effective number of species. From Hepner, M. E. (2017). Reef Fish Biodiversity in the Florida Keys National Marine Sanctuary.", src="mhepner_fig6.png"
)
```
